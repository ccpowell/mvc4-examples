...
namespace DRCOG.Domain.Helpers
{
    ...
    public static class StringEnumExtensions
    {
        ...
        public static string GetStringValue(this Enum e)
        {
            ...
            if (_stringValues.ContainsKey(e))
                output = (_stringValues[e] as StringValueAttribute).Value;
            else
            {
                //Look for our 'StringValueAttribute' in the field's custom attributes
    ...
    {
        public static Dictionary<string, string> ToDictionary(this string s, char splitter)
        {
