...
<fieldset>
    <div class="info">Select the projects from any another plan to bring into this cycle.</div>
...
<script type="text/javascript" charset="utf-8">
    var GetAvailableRestoreProjects = '<%=Url.Action("GetAvailableRestoreProjects","RTP") %>';
    ...
    $(document).ready(function() {
        ...
        $("#btn-restoreproject").colorbox({
            ...
            onComplete: function() {
                var $buttonRestoreProjects = $('<span id="button-restore-projects" class="cboxBtn">Restore</span>').appendTo('#cboxContent');
