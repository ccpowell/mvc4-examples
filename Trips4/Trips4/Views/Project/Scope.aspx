...
<div class="tab-content-container">
    ...
    <div class="tab-form-container tab-scope"> 
        <% using (Html.BeginForm("UpdateScope", "Project", FormMethod.Post, new { @id = "dataForm" })) %>
        <% { %>
            <fieldset>
           ...
           <p>
                <label>Begin Construction:</label>
    ...
    <div >
       <h2>Pool Projects<span> | Total Costs:<span id="project-costs-sum"></span></span></h2>
    ...
    <% foreach (var item in Model.PoolProjects.ToList<DRCOG.Domain.Models.TIPProject.PoolProject>()) { %>
        ...
        <tr id="pool_row_<%=item.PoolProjectID.ToString() %>">
            <td><%= Html.DrcogTextBox("poolproject_" + item.PoolProjectID.ToString() + "_ProjectName", Model.ProjectSummary.IsEditable(), item.ProjectName.ToString(), new { style = "width:200px;", @id = "poolproject_" + item.PoolProjectID.ToString(), @maxlength = "255" })%></td>
            <td><%= Html.DrcogTextBox("poolproject_" + item.PoolProjectID.ToString() + "_Description", Model.ProjectSummary.IsEditable(), item.Description.ToString(), new { style = "width:150px;", @maxlength = "75" })%></td>
            <td><%= Html.DrcogTextBox("poolproject_" + item.PoolProjectID.ToString() + "_BeginAt", Model.ProjectSummary.IsEditable(), item.BeginAt.ToString(), new { style = "width:100px;", @maxlength = "75" })%></td>
            <td><%= Html.DrcogTextBox("poolproject_" + item.PoolProjectID.ToString() + "_EndAt", Model.ProjectSummary.IsEditable(), item.EndAt.ToString(), new { style = "width:100px;", @maxlength = "75" })%></td>
            <td><%= Html.DrcogTextBox("poolproject_" + item.PoolProjectID.ToString() + "_Cost", Model.ProjectSummary.IsEditable(), (int)item.Cost, new { style = "width:100px;", @maxlength = "75", @alt = "money" })%></td>
        <%if(Model.ProjectSummary.IsEditable()){ %>
