...
Inherits="System.Web.Mvc.ViewPage<TipDashboardViewModel>" %>

<%@ Import Namespace="MvcContrib.UI.Grid"%>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">TIP Dashboard</asp:Content>
...
<%Html.RenderPartial("~/Views/TIP/Partials/TipTabPartial.ascx", Model.TipSummary); %>
    ...
    <div class="tab-form-container">
       <h2>Summary of <%= Model.TipSummary.TipYear %> TIP Projects</h2>
        ...
        <div class="quickTasks" style="display: <%= (Model.DashboardItems.Count <= 0 ? "block" : "none") %>;">
            <h2>Quick Tasks</h2>
            <span id="btn-restoreproject" class="fg-button w200 ui-state-default ui-corner-all">Import Projects</span>
        </div>
    </div>  
    ...
    <div class="helpContainer" style="display: none; ">
        <h2>TIP Dashboard</h2>        
        <p>Use this form to get the basic over view of the TIP</p>    
            <div class="ui-widget">
			</div>          
    </div>
