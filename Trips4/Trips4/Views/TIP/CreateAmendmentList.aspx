<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<DRCOG.Domain.ViewModels.TIP.ProjectListViewModel>" %>
...
<div class="view-content-container">
    <h2 style="float:left;">Create Amendment to a Project in the <%=Model.TipSummary.TipYear%> TIP </h2>
    <div class="clear"></div>
      
    <div class="tab-content-container">
        <h2>Amendable Projects</h2>

       <%= Html.Grid(Model.ProjectList).Columns(column => {
            column.For(x => Html.ActionLink("Create", "Amendments", new { controller="Project", year = Model.TipSummary.TipYear, id = x.ProjectVersionId })).Encode(false);
