<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<DRCOG.Domain.ViewModels.RTP.Project.DetailViewModel>" %>
    ...
    <div class="tab-content-container">
        ...
        <div id="details">
            <div id="scope" style="padding-top: 20px;">
                <h2 style="padding: 0 10px 10px 0px;">
                    Description: <span style="font-style: italic;">
                        <%= Model.GeneralInfo["ShortDescription"] %></span></h2>
                <ul>
                    ...
                    <li><span class="darkGrey boldFont">Amendment Status:</span> <span id="amendmentStatus">
                        ...
                        <%= Model.ProjectSummary.AmendmentStatus %></span></li>
                </ul>
            </div>
            <div id="regionMLeft">
                <h2>
                ...
                <table class="totalWidth">
                    <tr>
                        ...
                        <td>
                            <div class="totalWidth">
                                <%= Model.GeneralInfo["ProjectType"]%></div>
                        </td>
                    </tr>
                    <%--<tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="totalWidth">
                                <%= Model.GeneralInfo["PrimarySponsor"]%></div>
                        </td>
                    </tr>
                    <%--<tr>
            ...
            <% 
                // HACK! Format Constant Cost, which might be NULL or blank
                string coco = Model.GeneralInfo["ConstantCost"];
                if (!string.IsNullOrWhiteSpace(coco))
                {
                    coco = string.Format("{0:0,0.0}", Convert.ToDouble(coco));
                }
                else
                {
                    coco = "";
        ...
        <div id="notes">
            <table class="totalWidth">
                <tr>
                    <td>
                        Sponsor Notes:
                        <div class="blockoff totalWidth">
                            <%= Model.GeneralInfo["SponsorNotes"]%></div>
                    </td>
                    <td>
                        DRCOG Notes:
                        <div class="blockoff totalWidth">
                            <%= Model.GeneralInfo["DRCOGNotes"]%></div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="segments-wrapper">
            ...
            <table id="segments">
                ...
                <tr id="segment_row_<%=item.SegmentId.ToString() %>">
                    <td>
                        <%= item.FacilityName.ToString() %>
                    </td>
                    <td>
                        <%= item.ImprovementType.ToString() %>
                    </td>
                    <td>
                    ...
                    <td>
                        <%= item.Staging.ToString() %>
                    </td>
                    <td>
                        <%= item.OpenYear.ToString() %>
                    </td>
                </tr>
                <% } %>
            </table>
